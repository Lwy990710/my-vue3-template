    ...
    <div class="container_common">
      ...
      <div class="container_common_senionItems">
        <div class="container_btnGroup">
          ...
          >
            <el-button
              ...
              style="color: #666"
              plain
              class="container_btnGroup-btn handle-btn-search"
              @click.stop="search"
            >
              查询
            </el-button>
        ...
        <el-button
          ...
          style="color: #666"
          plain
          class="container_btnGroup-btn handle-btn-expand container_common_senionItems-text"
          @click.stop="showSenion"
        >
          {{ activeNames.length !== 0 ? '隐藏': '' }}高级筛选
        </el-button>
        <el-popover
          v-if="useDataFilter"
          placement="bottom"
...
<script setup>
const { onBeforeMount, reactive, ref } = require("vue-demi")
