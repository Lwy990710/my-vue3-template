...
<template>
  <div class="table">
    ...
    <div>
      ...
      <span v-if="showTips" style="display:inline-block;margin-left:20px;font-size:16px;color:red;height: 40px;line-height: 40px;">
        {{ tips }}
      </span>
    </div>
    <el-table
...
const props = defineProps({
  forMatData: {
    type: Function,
    default: (row, column) => { if (typeof row[column.property] === 'number') {
