...
const jxRequest = axios.create({
  // baseURL: 'http://8.134.93.171:9090/tms', // http 接口

  // baseURL: 'http://192.168.28.125:9090/tms', // 楷星ip

  // baseURL: 'http://192.168.28.113:9090/tms', // 文浩ip

  //baseURL: 'http://192.168.28.109:9090/tms', // 嫄袁ip

  //baseURL: 'http://192.168.28.108:9895/tms', // 进华ip

  // baseURL: 'https://platform.jiaxianwuliu.com:9900/tms',  https 接口

  //baseURL: 'https://logistics.jiaxianwuliu.com:9900/tms', // 新服务器接口

  baseURL: process.env.VUE_APP_TITLE !== 'pro' ? 'http://8.134.136.196:9895/tms' : 'https://logistics.jiaxianwuliu.com:9900/tms',
  headers: {
...
jxRequest.interceptors.response.use(
  ...
  response => {
    ...
    if (response.responseTime - response.config.requestStartTime >= 10000) {
      ElMessage.warning('网络不太好噢，刷新一下吧')
